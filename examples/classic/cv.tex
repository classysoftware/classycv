...
\classycvSet{/put heading/options/skip below}{0pt}
\classycvSet{/put heading/options/padding}{0pt}

% Set resume entry options.
\classycvSet{/put resume entry/options/skip above}{\baselineskip}
\classycvSet{/put resume entry/options/skip below}{0pt}
...
% experience
%%
\heading{\circle[border width=0pt, border color=accent-color, background color=accent-color, text color=white]{\faWrench}~~Arbeitserfahrung}%
%
\begin{Entry}{%
...
% education
%%
% We need a manual page break here for unknown reasons.
\newpage
\heading{\circle[border width=0pt, border color=accent-color, background color=accent-color, text color=white]{\faGraduationCap}~~Ausbildung}%
%
...
\end{Entry}
% 
\heading{\circle[border width=0pt, border color=accent-color, background color=accent-color, text color=white]{\faUser}~~Persönliche Fähigkeiten}%
%
...
%
\newpage%
\heading{\circle[border width=0pt, border color=accent-color, background color=accent-color, text color=white]{\faInfo}~~Zusätzliche Informationen}%
%
