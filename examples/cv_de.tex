%%
% German CV example.
% Adopted from example german cv on the Europass website (HREF[1]). Job application details from a real job posting at xing.com (HREF[2]).
%
% HREF[1] https://europass.cedefop.europa.eu/sites/default/files/cv-example-1-de_de.pdf
% HREF[2] https://www.xing.com/jobs/potsdam-referent-service-veranstaltungsmanagement-33219894?ijt=jb_18&paging_context=search&search_query%5Bkeywords%5D=veranstaltungskauffrau&search_query%5Bsort%5D=relevance&ttt_sp=15
%%
...
% experience
\heading[has label=yes, label position=left, label text=\faSuitcase, label color=accent-color, skip above=2em, skip below=0em, skip between=0.5em]{%
    \MakeUppercase{Berufserfahrung}}%
%
\begin{Entry}{%
...
% education
\newpage%
\heading[has label=yes, label position=left, label text=\faGraduationCap, label color=accent-color, skip above=2em, skip below=0em, skip between=0.5em]{\MakeUppercase{Ausbildung}}
%
...
\end{Entry}
%
\heading[has label=yes, label position=left, label text=\faWrench, label color=accent-color, skip above=2em, skip below=0em, skip between=0.5em]{\MakeUppercase{Persönliche Fähigkeiten}}
%
\begin{Entry}{%
    Sprachkenntnisse%
}{}%
...
\end{Entry}
%
\heading[has label=yes, label position=left, label text=\faInfo, label color=accent-color, skip above=2em, skip below=0em, skip between=0.5em]{\MakeUppercase{Zusätzliche Informationen}}
%
...
\end{Resume}
% Anlagen
% NOTE multi-page attachment 
%   \attachment[attachment name=Anhang: <Anhang1>][][height=0.85\paperheight]{<Anhang1>}
% NOTE single page attachment
%   \attachment[attachment name=Anhang: <Anhang2>][has page counter=no][height=0.85\paperheight]{<Anhang2>}
\end{document}