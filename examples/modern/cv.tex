...
\classycvDefineComponent{/resume/left/extra data}{%
    ...
    \heading[%
        ...
        , padding=0pt%
    ] {\circle[background color=white, text color=accent-color]\faWrench~~\MakeUppercase{Skills}}%
	\hspace*{24pt}%
...
%    , delimiter width=0pt%
    ...
    \heading[skip above=0pt]{\circle{\faSuitcase}~~Professional Experience}%
    ...
    \end{Entry}%
    %
    \heading{\circle{\faGraduationCap}~~Education}%
    ...
    \end{Entry}%
    %
    \heading{\circle{\faTrophy}~~Awards~\&~Achievements}%
