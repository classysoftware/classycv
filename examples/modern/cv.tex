...
\begin{Resume}[%
    ...
    \heading[padding=0pt, skip above=2\baselineskip, skip below=\baselineskip]{\circle[border width=2pt]{\faSuitcase}~~Professional Experience}%
    ...
    \end{Entry}%
    %
    \heading[padding=0pt, skip above=1\baselineskip, skip below=\baselineskip]{\circle[border width=2pt]{\faGraduationCap}~~Education}%
    ...
    \end{Entry}%
    %
    \heading[padding=0pt, skip above=\baselineskip, skip below=\baselineskip]{\circle[border width=2pt]{\faTrophy}~~Awards~\&~Achievements}%
